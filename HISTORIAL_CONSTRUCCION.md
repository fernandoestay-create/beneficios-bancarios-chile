...
| 13 | 2026-08-04 | **Cuotas a agosto + "Otros" ampliado a 571 + audit (v2.2→v2.4)**: cuotas re-curadas a agosto (11/14 bancos, 9 oficial-verificada), **"Otros beneficios" 24→571** — flips **L-32** de BCI (+172) y Lider BCI (+17) + **Banco de Chile** (+359, se quitó su filtro `meta.category` y se clasifica por categoría, con **GATE de 249 restaurantes con IDs idénticos** → `/ver` intacto). Trampas L-34 manejadas ($monto≠%, cuotas), **filtro de calidad DURABLE en el render** (L-40/L-41), Ripley región corregida |
