...
- **Revisión (2 agentes independientes, punto por punto):**
  ...
  - *"Otros beneficios" ampliado 24→212 (`ca07c4b`, `8a1b0e3`):* **BCI 23→195 + Lider BCI +17 = 212 verificables** (sus APIs CMS ya traían todo y lo botaban → volteadas con `seccion="otro"`, L-32; Lider manejó trampas L-34: "$100 Dcto."=monto ≠ 100%, ítems de cuotas excluidos). Filtro durable anti-financiamiento en el render (L-40/L-41). **`beneficios.json` NO tocado** (solo el dataset separado). Verificado en prod: BCI 172 + Santander 21 + Lider 17 + Consorcio 2. Próximo candidato flip: Banco de Chile (su API da 302 a curl, el scraper la maneja).
  - *Pendiente real (tu teléfono):* **Shell/Aramco** → oficial desde sus apps (Copec ya es oficial).
- Lecciones **L-38, L-39, L-40, L-41**. Commits: `9ad0e7f` firma Twilio · `d7603a3`/`680db29` vars Render · `bdf8646` Telegram · `637b7bf` bot 4 opciones · `79fc554` Scotiabank+Telegram · `ca07c4b` BCI otros · `8a1b0e3` Lider otros · `849b708` Ripley región. Tags: **`v2.2-cuotas-otros-audit`**, **`v2.3-lider-otros`**.
