...
- **Filtros:** arriba hay un **selector de mes** (junio a diciembre — cada campaña se muestra en los meses que está vigente, según su vigencia; abre en el mes en curso), los **logos de los bancos** (clic en un logo para filtrar ese banco) y chips de **categoría**.
